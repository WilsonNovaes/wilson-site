...
const links = [
  ...
  },
  {
    id: 'email',
    label: 'E-mail',
    handle: 'wilson@exemplo.com',
    description: 'Entre em contato direto',
    href: 'mailto:wilson@exemplo.com',
    icon: (
...
export default function SocialLinks() {
  return (
    <section className="social-section" aria-label="Links e redes sociais">
      <p className="social-label">Onde me encontrar</p>
      <ul className="social-list">
        {links.map((link, i) => (
          <li key={link.id} style={{ animationDelay: `${0.1 + i * 0.08}s` }}>
            <a
              href={link.href}
